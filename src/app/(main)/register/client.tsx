      ...
      {isLoading ? (
        ...
        <>
          ...
          >
            ...
            <span className="-mt-2">
              Create a new account to start working with APIs faster and easier
              than ever. Unlock the full potential of our tool, combining the
              best of Postman and GraphiQL.
            </span>
            <TextInput
              label="Name"
